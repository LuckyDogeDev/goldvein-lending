...
import "../../contracts/GoldVeinPair.sol";
import "@luckyfinance/alpine-sdk/contracts/IAlpineV1.sol";

contract GoldVeinPairHarness is GoldVeinPair {
	constructor() GoldVeinPair(IAlpineV1(0)) public { }
	...
	// totalAssetBase() is already defined in GoldVeinPair.sol with the name totalSupply
	...
	function symbolicCook(uint8 action) external virtual payable
        ...
        CookStatus memory status;
            ...
            } else if (action == ACTION_@LUCKYFINANCE_SETAPPROVAL) {
