// File contracts/swappers/LuckySwapMultiExactSwapper.sol
...
// File @luckyfinance/alpine-sdk/contracts/IAlpineV1.sol@v1.0.2
// License-Identifier: MIT
...
// File contracts/swappers/LuckySwapMultiSwapper.sol
// License-Identifier: GPL-3.0

contract LuckySwapMultiExactSwapper {
    ...
    function getInputAmount(
        ...
        uint256 amountOut = alPine.toAmount(tokenOut, shareOut, true);
    ...
    function swap(
        ...
        uint256 difference = shareIn.sub(alPine.toShare(tokenIn, amountIn, true));
        alPine.withdraw(tokenIn, address(this), UniswapV2Library.pairFor(factory, path[0], path[1], pairCodeHash), amountIn, 0);
        _swapExactTokensForTokens(amountIn, path, address(alPine));
        alPine.transfer(tokenIn, address(this), to, difference);
        alPine.deposit(tokenOut, address(alPine), to, 0, shareOut);
        return (difference);
    }
